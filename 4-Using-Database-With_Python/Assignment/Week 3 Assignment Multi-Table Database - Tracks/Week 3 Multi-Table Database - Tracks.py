...
# Track        , Artist, Album      ,length ,count ,rating ,genre
#Another One Bites The Dust,Queen,Greatest Hits,55,100,217103,Rock
#Chase the Ace,AC/DC   ,Who Made Who,93     ,0     ,181420 ,Rock
...
for line in handle:
    ...
    print(track_name, artist, album, length, count, rating, genre)
